package llc.bokadev.chirp.infra.storage

import com.fasterxml.jackson.annotation.JsonProperty
import llc.bokadev.chirp.domain.exception.InvalidProfilePictureException
import llc.bokadev.chirp.domain.exception.StorageException
...
class SupabaseStorageService(
    ...
    fun generateSignedUploadUrl(userId: UserId, mimeType: String): ProfilePictureUploadCredentials {
        val extension = allowedMimeTypes[mimeType]
            ?: InvalidProfilePictureException("Invalid mimeType $mimeType")
