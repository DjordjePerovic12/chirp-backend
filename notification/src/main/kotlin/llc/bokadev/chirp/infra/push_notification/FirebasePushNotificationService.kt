package llc.bokadev.chirp.infra.push_notification
...
import llc.bokadev.chirp.domain.models.PushNotificationSendResult
...
class FirebasePushNotificationService(
    ...
    fun initialize() {
        try {
            ...
            logger.error("Error initializing Firebase Admin SKD", e)
            throw e
        }
    }
